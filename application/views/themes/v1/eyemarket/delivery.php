    ...
    <div class="col-md-9 clearfix" id="checkout">
        ...
        <div class="box">
            <ul class="nav nav-pills nav-justified">
                ...
                <li class="active"><a href="#"><i class="fas fa-truck"></i><br>Metode Pengiriman</a>
                </li>
            ...
            <div id="reqkurir" class='loadkurir' action="eyemarket" loading="off" clean="clsmarket">
                <div id='clsmarket'>
                    <script>
                        $(document).ready(function(){
                            $(window).on('load',function(){
                                ajaxOnLoad('loadkurir');
                            });
                        });
                    </script>
                </div>
                <input type='hidden' name='fn' value='view_delivery' class='cinput'>
            </div>
