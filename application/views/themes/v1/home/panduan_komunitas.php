<div class="container-full">
	<div class="box-90">
		<div class="kebijakan panduan">
			<h1>Panduan Komunitas</h1>
			<h2>A. Mendaftar</h2>
			<h3>Pendaftaran Liga Pelajar U16</h3>
			<span>Panduan pendaftaran tim ada <a href="">disini</a></span>
			<h3>Pendaftaran Liga Santri Nusantara</h3>
			<span>Panduan pendaftaran tim ada <a href="">disini</a></span>
			<h3>Pendaftaran Member</h3>
			<span>Dengan mendaftar sebagai member, Anda akan mengakses... serta... Silahkan melihat panduannya <a href="">disini</a></span>
			<h2>B. Berinteraksi</h2>
			<p><span>Like :</span> Menyukai sebuah berita dan video di Eyesoccer dengan menekan tombol berbentuk hati.</p>
			<p><span>Share :</span> Stay Updated! Bagikan setiap berita atau video terbaru atau yang anda sukai kepada orang lain melalui aplikasi media sosial Anda dengan menekan tombol yang tersedia.</p>
			<p><span>Report :</span> Anda dapat melaporkan berita atau video yang dianggap berisi konten yang dapat mengganggu kepentingan pribadi, kabar bohong (hoax), pornografi, perjudian, kekerasan, spam, ataupun mengandung SARA yang melanggar peraturan perundang-undangan.</p>
			<h2>C. Syarat dan Ketentuan Aktifitas</h2>
			<p class="border">Berikut adalah hal-hal yang mempengaruhi aktivitas Anda selama mengakses Eyesoccer. Hal-hal dibawah ini dapat menyebabkan komentar, nama akun, nama user, foto profil, dan bio yang Anda buat kami hapus bahkan hingga menyebabkan akun Anda kami nonaktifkan. Kami memiliki hak untuk menghapus atau melakukan suspen terhadap pelanggaran seperti yang telah ditulis pada Ketentuan dan Kebijakan Privasi<br><br>
			...
			<h2>D. Eyesoccer publisher</h2>
			<p>
					Eyesoccer membuka kesempatan bagi komunitas dan entitas media baik cetak maupun online yang ingin menambah channel distribusi konten dengan membuka akun Eyesoccer tipe publisher. Fitur ini memungkinkan entitas media cetak maupun online untuk mengundang penulis-penulis yang sesuai untuk menjadi kontributor di akun Eyesoccer publishernya. Pertanyaan seputar fitur publisher dapat ditanyakan ke alamat email <a href="mailto:kolaborasi@eyesoccer.com">kolaborasi@eyesoccer.com</a>.Anda dapat melakukan pengajuan untuk membuat akun Publisher dengan mengisi "form berikut". Tim komunitas akan melakukan peninjauan ulang terhadap profil Anda sebelum membuka akses pembuatan akun Publisher.
			</p>
		</div>
	</div>
</div>